...
| Configuration                                                          | Default         | Purpose                                                                                                                                                                                                                                                        |
| ---------------------------------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Cfg p="--policy-import-path" e="MEMORY_SERVICE_POLICY_IMPORT_PATH" /> | Image-dependent | Comma-separated policy files and directories. Directories are searched recursively for `.yaml` and `.yml` documents. Only documents with `kind: memory-kind` are imported as memory-kind versions. The distributed image uses `/etc/memory-service/policies/`. |
