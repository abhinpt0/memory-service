...
| Flag                                                                 | Values | Default         | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------------------------------------------------- | ------ | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <Cfg p="--policy-import-dir" e="MEMORY_SERVICE_POLICY_IMPORT_DIR" /> | path   | image-dependent | Shared policy import root. Optional `authz.rego` and `filter.rego` replace the built-in global memory policies; `.yaml` and `.yml` files are discovered recursively, and only documents with `kind: memory-kind` import immutable database-backed memory-kind versions. The distributed container image defaults to `/etc/memory-service/policies/`. See [Policy Import Directory Configuration](/docs/concepts/memories/#policy-import-directory-configuration) for directory layout, filename, discriminator, and Rego entrypoint rules. |
