...
func (e *postgresEpisodicStore) AdminListMemories(ctx context.Context, query registryepisodic.AdminMemoryQuery) (registryepisodic.AdminMemoryPage, error) {
	...
	q = q.Where(postgresMemoryArchiveWhere("m", query.Archived))
	if query.KeyPrefix != "" {
...
func (e *postgresEpisodicStore) AdminSearchMemories(ctx context.Context, query registryepisodic.AdminMemorySearchQuery) ([]registryepisodic.MemoryItem, error) {
	limit := query.Limit
	if limit <= 0 {
		limit = 10
	}
...
func (e *postgresEpisodicStore) AdminListNamespaces(ctx context.Context, query registryepisodic.AdminNamespaceQuery) (registryepisodic.AdminNamespacePage, error) {
	limit := query.Limit
	if limit <= 0 {
		limit = 200
	}
...
func (e *postgresEpisodicStore) adminRowsToPage(rows []memoryRow, limit int) (registryepisodic.AdminMemoryPage, error) {
